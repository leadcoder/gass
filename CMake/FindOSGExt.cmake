...
macro(add_bin_rel _BIN_NAME)
	...
	find_file(${_VAR_NAME} NAMES ${PARSED_ARGS_NAMES} HINTS ${OSG_REL_BINARY_DIR})
...
macro(add_bin_dbg _BIN_NAME)
	...
	find_file(${_VAR_NAME} NAMES ${PARSED_ARGS_NAMES} HINTS ${OSG_DBG_BINARY_DIR})
...
if (WIN32)
	find_path(OSG_REL_BINARY_DIR ${OSG_SHARED_PREFIX}osg.dll HINTS ${OSG_DIR}/bin)
	find_path(OSG_DBG_BINARY_DIR ${OSG_SHARED_PREFIX}osgd.dll HINTS ${OSG_DIR}/bin ${OSG_DIR}/debug/bin)

	find_file(OSG_BINARY_REL NAMES ${OSG_SHARED_PREFIX}osg${_SHARED_LIB_EXT} HINTS ${OSG_REL_BINARY_DIR})
	find_file(OSG_BINARY_DBG NAMES ${OSG_SHARED_PREFIX}osgd${_SHARED_LIB_EXT} HINTS ${OSG_DBG_BINARY_DIR})
	
	find_file(OSG_OT_BINARY_REL NAMES ot21-OpenThreads${_SHARED_LIB_EXT} ot20-OpenThreads${_SHARED_LIB_EXT} HINTS ${OSG_REL_BINARY_DIR})
	find_file(OSG_OT_BINARY_DBG NAMES ot21-OpenThreadsd${_SHARED_LIB_EXT} ot20-OpenThreadsd${_SHARED_LIB_EXT} HINTS ${OSG_DBG_BINARY_DIR})
	...
	foreach(_OSG_MODULE ${OSG_MODULES})
		...
		find_file(${_COMP_NAME_REL} NAMES ${OSG_SHARED_PREFIX}${_OSG_MODULE}${_SHARED_LIB_EXT} HINTS ${OSG_REL_BINARY_DIR})
		find_file(${_COMP_NAME_DBG} NAMES ${OSG_SHARED_PREFIX}${_OSG_MODULE}d${_SHARED_LIB_EXT} HINTS ${OSG_DBG_BINARY_DIR})
	...
	set(OSGPLUGINS_REL_BINARY_DIRS ${OSG_REL_BINARY_DIR}/osgPlugins-${OSG_VERSION})
	set(OSGPLUGINS_DBG_BINARY_DIRS ${OSG_DBG_BINARY_DIR}/osgPlugins-${OSG_VERSION})# ${CMAKE_PREFIX_PATH})
	...
	foreach(_OSG_PLUGIN ${OSG_PLUGINS})
		...
		find_file(${_PLUGIN_NAME_REL} 
			NAMES osgdb_${_OSG_PLUGIN}${_SHARED_LIB_EXT} 
			HINTS ${OSGPLUGINS_REL_BINARY_DIRS}
			PATH_SUFFIXES tools/osg/osgPlugins-${OSG_VERSION}
		)
		find_file(${_PLUGIN_NAME_DBG} 
			NAMES osgdb_${_OSG_PLUGIN}d${_SHARED_LIB_EXT} 
			HINTS ${OSGPLUGINS_DBG_BINARY_DIRS}
			PATH_SUFFIXES debug/tools/osg/osgPlugins-${OSG_VERSION})
