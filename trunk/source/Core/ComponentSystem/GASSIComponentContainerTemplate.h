...
#ifndef GASS_I_COMPONENT_CONTAINER_TEMPLATE_H
#define GASS_I_COMPONENT_CONTAINER_TEMPLATE_H
...
namespace GASS
{
	...
	typedef WPTR<IComponentContainerTemplate> ComponentContainerTemplateWeakPtr;
