...
#include "Sim/Systems/Input/GASSController.h"
...
namespace GASS
{
	...
	ControlSettingsManager::ControlSettingsManager()
	{
	...
	void ControlSettingsManager::Update(double delta_time)
	{
	...
	ControlSetting* ControlSettingsManager::NewRemoteControlSetting(const std::string &name)
	{
	...
	void ControlSettingsManager::Add(const std::string &name,ControlSetting* cs)
	{
		assert(cs); 
