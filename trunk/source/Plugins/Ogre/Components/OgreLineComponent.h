...
{
	class DynamicLines;
	class OgreLineComponent : public Reflection<OgreLineComponent ,BaseSceneComponent> , public ILineComponent , public IGeometryComponent
	{
	public:
		OgreLineComponent(void);
		~OgreLineComponent(void);
		...
		Ogre::ManualObject* GetLineObject() const {return m_LineObject;}
	protected:
