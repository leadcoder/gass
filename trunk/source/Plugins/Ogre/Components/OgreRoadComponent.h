...
namespace GASS
{
	...
	class OgreRoadComponent : public Reflection<OgreRoadComponent,BaseSceneComponent>
	{
	public:
		OgreRoadComponent();
		virtual ~OgreRoadComponent();
	...
	typedef SPTR<OgreRoadComponent> OgreRoadComponentPtr;
	typedef WPTR<OgreRoadComponent> OgreRoadComponentWeakPtr;
