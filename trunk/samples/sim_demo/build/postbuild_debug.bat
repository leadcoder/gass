...
copy %OGRE_HOME%\bin\debug\Plugin_ParticleFX_d.dll ..\bin\debug\
copy %OGRE_HOME%\bin\debug\RenderSystem_Direct3D9_d.dll ..\bin\Debug\
copy %OGRE_HOME%\bin\debug\RenderSystem_GL_d.dll ..\bin\Debug\
rem copy %OGRE_HOME%\bin\debug\OIS_d.dll ..\bin\Debug\
