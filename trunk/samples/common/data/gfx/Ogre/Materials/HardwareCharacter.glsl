...
uniform vec4 boneTransforms[246];
...
void main(void)
{
   ...
   float boneWeights[4];//float[](gl_MultiTexCoord1.x, gl_MultiTexCoord1.y, gl_MultiTexCoord1.z, gl_MultiTexCoord2.w);
   float boneIndices[4];//int[](gl_MultiTexCoord3.x, gl_MultiTexCoord3.y, gl_MultiTexCoord3.z, gl_MultiTexCoord3.w);
   
   boneWeights[0] = gl_MultiTexCoord1.x; boneWeights[1] = gl_MultiTexCoord1.y; boneWeights[2] = gl_MultiTexCoord1.z; boneWeights[3] = gl_MultiTexCoord1.w;
   boneIndices[0] = gl_MultiTexCoord2.x; boneIndices[1] = gl_MultiTexCoord2.y; boneIndices[2] = gl_MultiTexCoord2.z; boneIndices[3] = gl_MultiTexCoord2.w;
