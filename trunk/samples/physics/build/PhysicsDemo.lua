...
if (os.is("windows")) then
	...
	configuration "Debug"
		...
		postbuildcommands 
		{
			...
			"copy ..\\..\\..\\lib\\GASSPluginOSG_d.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\GASSPluginOIS_d.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\GASSPluginODE_d.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\GASSPluginPhysX_d.dll ..\\bin\\$(ConfigurationName)" ,
	...
	configuration "Release"
		...
		postbuildcommands 
		{
			...
			"copy ..\\..\\..\\lib\\GASSPluginOSG.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\GASSPluginOIS.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\GASSPluginODE.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\GASSPluginPhysX.dll ..\\bin\\$(ConfigurationName)" ,
