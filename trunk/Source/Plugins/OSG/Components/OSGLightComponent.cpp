...
#include "Core/Object/IGameObjectManager.h"
#include "Core/Object/GameObject.h"
#include "Core/MessageSystem/MessageManager.h"
#include "Core/MessageSystem/Message.h"
#include "Sim/Scenario/ScenarioScene.h"
...
namespace HiFi
{
	...
	{
		int obj_id = (int) this;
		MessageManager * mm = GetOwner()->GetMessageManager();
	...
	void OgreLightComponent::OnLoad(MessagePtr message)
	{
		...
		OgreLocationComponent * lc = GetOwner()->GetFirstComponent<OgreLocationComponent>();
