...
cmake -DCMAKE_EXE_LINKER_FLAGS="-Wl,--no-as-needed" -DCMAKE_BUILD_TYPE=Release  -DGASS_BUILD_CORE_SAMPLES=OFF -DGASS_BUILD_SIM_SAMPLES=OFF -DGASS_BUILD_SIM=OFF  $SOURCE_ROOT
