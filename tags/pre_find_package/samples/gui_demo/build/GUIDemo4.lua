...
if (os.is("windows")) then
	...
	configuration "Debug"
		...
		postbuildcommands 
		{
			...
			"copy ..\\..\\..\\lib\\" .. _ACTION .. "\\GASSPluginScript_d.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\" .. _ACTION .. "\\GASSPluginCEGUI_d.dll ..\\bin\\$(ConfigurationName)" ,
			"postbuild_debug.bat" 
		}
	...
	configuration "Release"
		...
		postbuildcommands 
		{
			...
			"copy ..\\..\\..\\lib\\" .. _ACTION .. "\\GASSPluginScript.dll ..\\bin\\$(ConfigurationName)" ,
			"copy ..\\..\\..\\lib\\" .. _ACTION .. "\\GASSPluginCEGUI.dll ..\\bin\\$(ConfigurationName)" ,
