...
namespace GASS
{
	...
	*/
	...
	/**
		...
		The inheritance from GASS_ENABLE_SHARED_FROM_THIS is used to
		get hold of ourself (this) as a shared pointer with the
		shared_from_this() function.
	*/

	class GASSCoreExport ComponentContainer : public Reflection<ComponentContainer, BaseReflectionObject> , public GASS_ENABLE_SHARED_FROM_THIS<ComponentContainer>, public IXMLSerialize, public ISerialize,  public IMessageListener
	{
	public:
		...
		*/
		virtual ComponentContainerPtr GetParent() const {return m_Parent.lock();}//allow null pointer}
