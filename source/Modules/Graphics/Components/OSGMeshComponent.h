...
namespace GASS
{
	class OSGMeshComponent : public Reflection<OSGMeshComponent,Component> , public IMeshComponent , public IGeometryComponent, public IResourceComponent, public IImGuiComponent
	{
	public:
