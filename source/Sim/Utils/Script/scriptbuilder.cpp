...
int CScriptBuilder::StartNewModule(asIScriptEngine *scriptEngine, const char *moduleName)
{
	if( scriptEngine == 0 ) return -1;

	this->engine = scriptEngine;
	module = scriptEngine->GetModule(moduleName, asGM_ALWAYS_CREATE);
	if( module == 0 )
		return -1;
