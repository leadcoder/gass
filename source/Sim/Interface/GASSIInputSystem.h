...
namespace GASS
{
	...
	enum
	{
		DEVICE_MOUSE,
		DEVICE_KEYBOARD,
		DEVICE_GAME_CONTROLLER_0,	// Note: Keep these in order
		DEVICE_GAME_CONTROLLER_1,
		DEVICE_GAME_CONTROLLER_2,
		DEVICE_GAME_CONTROLLER_3,
		DEVICE_GAME_CONTROLLER_4
	};
	...
	enum
	{
		...
		POV_EAST      = 0x0100,
		POV_WEST      = 0x1000,
		POV_NORTHEAST = 0x0101,
		POV_SOUTHEAST = 0x0110,
		POV_NORTHWEST = 0x1001,
	...
	*/
	...
	typedef GASS_SHARED_PTR<IInputSystem> InputSystemPtr;
	...
	typedef GASS_SHARED_PTR<IProxyInputSystem> ProxyInputSystemPtr;
}
