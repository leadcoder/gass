...
namespace GASS
{
	...
	public:
		virtual bool GetClosestPointOnMeshForPlatform(const PlatformType platform_type, const Vec2 &in_pos, const float search_radius, Vec3 &out_pos) const = 0;
		virtual bool Raycast(const PlatformType platform_type, const Vec3 &from_pos, const Vec3 &to_pos, Vec3 &hit_pos) const = 0;
