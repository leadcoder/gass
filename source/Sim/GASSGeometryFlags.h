...
namespace GASS
{
	...
	*/
	...
	enum GeometryFlags
	{
		...
		GEOMETRY_FLAG_GROUND_LOD			=   1 << 10,
		
		GEOMETRY_FLAG_ALL					=   GEOMETRY_FLAG_UNKNOWN | GEOMETRY_FLAG_GROUND | GEOMETRY_FLAG_STATIC_OBJECT | GEOMETRY_FLAG_DYNAMIC_OBJECT | GEOMETRY_FLAG_TRANSPARENT_OBJECT | GEOMETRY_FLAG_EDITOR | GEOMETRY_FLAG_GIZMO | GEOMETRY_FLAG_RAY_CAST_WHEEL | GEOMETRY_FLAG_VEHICLE_CHASSIS | GEOMETRY_FLAG_PAGED_LOD | GEOMETRY_FLAG_GROUND_LOD,
