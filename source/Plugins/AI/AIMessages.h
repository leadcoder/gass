...
namespace GASS
{
	...
	typedef GASS_SHARED_PTR<DoorMessage> DoorMessagePtr;
	...
	typedef GASS_SHARED_PTR<HealthChangedEvent> HealthChangedEventPtr;
	...
	typedef GASS_SHARED_PTR<StanceChangedMessage> StanceChangedMessagePtr;*/
