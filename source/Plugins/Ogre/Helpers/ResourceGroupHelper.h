...
private:
   ...
   class MyMatVisitor : public Ogre::Renderable::Visitor
   {
   private:
      MyMatVisitor(const MyMatVisitor&);///<\brief anti copyconstructor
      MyMatVisitor& operator=(const MyMatVisitor&);///<\brief anti affector
   public: 
