...
bool InputGeom::createMesh(float* verts, float* normals, int* areas, int* tris, int vert_count,int tri_count)
{
	if (m_mesh)
	{
		delete m_chunkyMesh;
	...
	if (!m_mesh->load(verts, normals, areas, tris, vert_count,tri_count))
	{
