...
namespace GASS
{
	...
	void FollowWaypointListComponent::RegisterReflection()
	{
		...
		RegisterProperty<SceneObjectRef>("NavigationObject", &FollowWaypointListComponent::GetNavigationObject, &FollowWaypointListComponent::SetNavigationObject,
			SceneObjectEnumerationProxyPropertyMetaDataPtr(new SceneObjectEnumerationProxyPropertyMetaData("Object that hold navigation component",PF_VISIBLE,NavigationEnumeration)));
