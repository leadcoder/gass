...
namespace GASS
{
	...
	void RakNetMasterReplica::RemoteInit(RakNet::BitStream *inBitStream, RakNet::Time timestamp, NetworkID networkID, RakNet::SystemAddress senderId)
	{
		RakNetNetworkSystemPtr raknet = SimEngine::Get().GetSimSystemManager()->GetFirstSystemByClass<RakNetNetworkSystem>();
	...
	ReplicaReturnResult RakNetMasterReplica::SendConstruction( RakNet::Time currentTime, RakNet::SystemAddress systemAddress, unsigned int &flags, RakNet::BitStream *outBitStream, bool *includeTimestamp )
	{
	...
	ReplicaReturnResult  RakNetMasterReplica::SendDestruction(RakNet::BitStream *outBitStream, RakNet::SystemAddress systemAddress, bool *includeTimestamp)
	{
		// Optional, nothing to send here.
		return REPLICA_PROCESSING_DONE;
	}

	ReplicaReturnResult RakNetMasterReplica::ReceiveDestruction(RakNet::BitStream *inBitStream, RakNet::SystemAddress systemAddress, RakNet::Time timestamp)
	{
	...
	ReplicaReturnResult RakNetMasterReplica::SendScopeChange(bool inScope, RakNet::BitStream *outBitStream, RakNet::Time currentTime, RakNet::SystemAddress systemAddress, bool *includeTimestamp)
	{
		outBitStream->Write(inScope);
		return REPLICA_PROCESSING_DONE;
	}

	ReplicaReturnResult RakNetMasterReplica::ReceiveScopeChange(RakNet::BitStream *inBitStream, RakNet::SystemAddress systemAddress, RakNet::Time timestamp)
	{
		return REPLICA_PROCESSING_DONE;
	}

	ReplicaReturnResult RakNetMasterReplica::Serialize(bool *sendTimestamp, RakNet::BitStream *outBitStream, RakNet::Time lastSendTime, PacketPriority *priority, PacketReliability *reliability, RakNet::Time currentTime, RakNet::SystemAddress systemAddress, unsigned int &flags)
	{
		// Don't send back to the owner of an object.
		//if (playerId==m_Owner)
		//	return REPLICA_PROCESSING_DONE;
	...
	ReplicaReturnResult RakNetMasterReplica::Deserialize(RakNet::BitStream *inBitStream, RakNet::Time timestamp, RakNet::Time lastDeserializeTime, RakNet::SystemAddress systemAddress )
	{
